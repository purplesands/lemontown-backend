...
class DaysControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create day" do
    assert_difference('Day.count') do
      post days_url, params: { day: { word1: @day.word1, word2: @day.word2, word3: @day.word3 } }, as: :json
    end
  ...
  test "should update day" do
    patch day_url(@day), params: { day: { word1: @day.word1, word2: @day.word2, word3: @day.word3 } }, as: :json
    assert_response 200
  end
